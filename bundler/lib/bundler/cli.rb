...
module Bundler
  class CLI < Thor
    ...
    method_option :coc, type: :string, lazy_default: Bundler.settings["gem.coc"] || "", enum: %w[contributor-covenant ruby], banner: "Generate a code of conduct file, either Contributor Covenant or Ruby. Set a default with `bundle config set --global gem.coc (contributor-covenant|ruby)`"
